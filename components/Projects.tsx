...
export const Projects: React.FC<ProjectsProps> = ({ id }) => {
  ...
  const allProjects: ProjectItem[] = [
    { id: 'p1', title: 'Website Designs', category: 'UI/UX', imageUrl: '/assets/fokal.png', description: 'Web Design' },
    { id: 'p2', title: 'Mobile App', category: 'UI/UX', imageUrl: '/assets/dibbz.png', description: 'App Design' },
    { id: 'p3', title: 'Branding', category: 'Branding', imageUrl: '/assets/elvion.png', description: 'Identity Design' },
    { id: 'p4', title: 'Illustrations', category: 'Illustrations', imageUrl: '/assets/illustrations.png', description: 'Digital Illustration' },
    { id: 'p5', title: 'Art Collection', category: 'Art Collection', imageUrl: '/assets/potraits.png', description: 'Digital Painting' },
  ];
